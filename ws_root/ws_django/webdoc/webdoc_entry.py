...
class WebdocEntry:
  ...
  def loadFromDataFolder(self, dataFolder):
    ...
    #Locate html file
    path = ws_globals.blogGeneratedFolder + '/' + dataFolder
    files = []
    ...
    if htmlFile is not None:
      fh = open(ws_globals.blogGeneratedFolder + '/' + dataFolder + '/' + htmlFile, 'r')
      self.__html = fh.read()
      fh.close()
    ...
    if metaFile is not None:
      ...
      webdocMetadata.loadFile(ws_globals.blogGeneratedFolder + '/' + dataFolder + '/' + metaFile)
